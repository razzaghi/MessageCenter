...
insert  into `community`(`id`,`hashId`,`name`,`description`,`created`) values (1,'1','واحد نرم افزار','Salam','0000-00-00 00:00:00'),(2,'9tpvejk9','واحد عمومی','','2015-06-08 11:31:44'),(3,'2','واحد شبکه','شبکه','2015-06-08 11:31:45');
...
insert  into `post`(`id`,`hashId`,`created`,`dateCreated`,`title`,`text`,`vote`,`commentsCount`,`userId`,`communityId`) values (1,'ryi1k7q8','2015-06-08 11:27:16','2015-06-08','test','<p>test</p>',2,0,1,1);
...
insert  into `users_communities`(`userId`,`communityId`) values (1,1),(1,2),(1,3);
...
insert  into `vote_post`(`vote`,`datetime`,`postId`,`userId`) values (1,'2015-06-09 09:24:08',1,1);
